...
class GatedTCN(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=2, dilation=1):
        ...
        # Skip connection preserves temporal info
    ...
    def forward(self, x):
        ...
        #  Skip connection keeps full temporal dimension
...
class SpatialTemporalLayer(nn.Module):
    """
    Added Layer Normalization as per paper Section 4.2
...
class GraphWaveNet(nn.Module):
    ...
    def __init__(self, num_nodes, in_channels=1, out_channels=1,
        ...
        #  Skip aggregation with temporal pooling
